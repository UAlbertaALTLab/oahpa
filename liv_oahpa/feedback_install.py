...
from .liv_drill.models import Feedbackmsg,Feedbacktext,Dialect,Comment,Tag
...
from .liv_drill.models import Form
...
class Feedback_install(object):
	...
	def read_feedback(self, feedbackfile, wordfile, append):
		...
		if Feedbackmsg.objects.count() == 0:
			print("No message strings have been installed (messages.liv.xml, etc).", file=sys.stderr)
			sys.exit()
