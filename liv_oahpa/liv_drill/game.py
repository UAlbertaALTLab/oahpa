...
from liv_oahpa.liv_drill.models import *
from liv_oahpa.liv_drill.forms import *
...
try:
	L1 = liv_oahpa.settings.L1
except:
	L1 = 'liv'  # was: sme

try:
	LOOKUP_TOOL = liv_oahpa.settings.LOOKUP_TOOL
except:
	LOOKUP_TOOL = 'lookup'


try:
	FST_DIRECTORY = liv_oahpa.settings.FST_DIRECTORY
except:
	FST_DIRECTORY = False

try:
	DEFAULT_DIALECT = liv_oahpa.settings.DEFAULT_DIALECT
except:
