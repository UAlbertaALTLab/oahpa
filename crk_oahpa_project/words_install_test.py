...
class Words(object):
    ...
    def install_lexicon(
        self, infile, linginfo, delete=None, paradigmfile=False, verbose=True
    ):
        global VERBOSE
        VERBOSE = verbose
        ...
        if pregenerated:
            ...
            for dialect in dialect_objects:
                ...
                generated_forms = linginfo.get_paradigm(
                    lemma=lemma, pos=pos, forms=forms, dialect=dialect.dialect
                )
            ...
            paradigms_to_create = OrderedDict(
