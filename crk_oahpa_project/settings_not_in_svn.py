...
GAME_FSTS = {
    ...
    "money": {
        "generate": FST_DIRECTORY
        + "/transcriptor-money-digit2text.filtered.lookup.hfstol",
        "answers": FST_DIRECTORY
        + "/transcriptor-money-text2digit.filtered.lookup.hfstol",
    },
}
